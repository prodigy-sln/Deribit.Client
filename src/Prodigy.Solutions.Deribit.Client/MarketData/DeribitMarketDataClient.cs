...
public class DeribitMarketDataClient
{
    ...
    public Task<IReadOnlyCollection<BookSummaryResponse>?> GetBookSummaryByCurrencyAsync(CurrencyKind currency,
        InstrumentKind? kind = null)
    {
        var request = Utilities.ConvertParametersToExpandoObject(currency, kind);
        return _deribitClient.InvokeAsync<IReadOnlyCollection<BookSummaryResponse>>(
            "public/get_book_summary_by_currency", request);
    }

    public Task<BookSummaryResponse?> GetBookSummaryByInstrumentAsync(string instrumentName)
    {
        return _deribitClient.InvokeAsync<BookSummaryResponse>("public/get_book_summary_by_instrument",
            Utilities.ConvertParametersToExpandoObject(instrumentName));
    }

    public async Task<int?> GetContractSizeAsync(string instrumentName)
    {
        var response = await _deribitClient.InvokeAsync<ContractSizeResponse>("public/get_contract_size",
            Utilities.ConvertParametersToExpandoObject(instrumentName));
    ...
    public async Task<IReadOnlyCollection<DeliveryPriceResponse>?> GetDeliveryPricesAsync(string indexName,
        int? offset = null, int? count = null)
    {
        var response = await _deribitClient.InvokeAsync<IReadOnlyCollection<DeliveryPriceResponse>>(
            "public/get_delivery_prices", Utilities.ConvertParametersToExpandoObject(indexName, offset, count));
        return response;
    }
    ...
    public async Task<IReadOnlyCollection<FundingRateHistoryResponse>?> GetFundingRateHistoryAsync(
        string instrumentName, long startTimestamp, long endTimestamp)
    {
        var requestParameters =
            Utilities.ConvertParametersToExpandoObject(instrumentName, startTimestamp, endTimestamp);
        var response =
            await _deribitClient.InvokeAsync<IReadOnlyCollection<FundingRateHistoryResponse>>(
                "public/get_funding_rate_history", requestParameters);
        return response;
    }
    ...
    {
        return await _deribitClient.InvokeAsync<IReadOnlyCollection<HistoricalVolatilityResponse>>(
            "public/get_historical_volatility", Utilities.ConvertParametersToExpandoObject(currency));
    }
    ...
    {
        return _deribitClient.InvokeAsync<InstrumentResponse>("public/get_instrument",
            Utilities.ConvertParametersToExpandoObject(instrumentName));
    }

    public Task<IReadOnlyCollection<InstrumentResponse>?> GetInstrumentsAsync(CurrencyKind currency,
    ...
    public async Task<SettlementResponse?> GetLastSettlementsByCurrencyAsync(string currency, string? type = null,
        int? count = null, string? continuation = null, long? searchStartTimestamp = null)
    {
        var request =
            Utilities.ConvertParametersToExpandoObject(currency, type, count, continuation, searchStartTimestamp);
        ...
        long? searchStartTimestamp = null)
    {
        ...
        return await _deribitClient.InvokeAsync<SettlementResponse>("public/get_last_settlements_by_instrument",
            request);
    }

    public async Task<LastTradesResponse?> GetLastTradesByCurrencyAsync(string currency, string? kind = null,
        string? startId = null, string? endId = null, long? startTimestamp = null, long? endTimestamp = null,
        int? count = 10, string? sorting = null)
    {
        var request = Utilities.ConvertParametersToExpandoObject(currency, kind, startId, endId, startTimestamp,
            endTimestamp, count, sorting);
        return await _deribitClient.InvokeAsync<LastTradesResponse>("public/get_last_trades_by_currency", request);
    }

    public async Task<LastTradesResponse?> GetLastTradesByCurrencyAndTimeAsync(string currency, long startTimestamp,
        long endTimestamp, string? kind = null, int? count = 10, string? sorting = null)
    {
        var request =
            Utilities.ConvertParametersToExpandoObject(currency, kind, startTimestamp, endTimestamp, count, sorting);
        return await _deribitClient.InvokeAsync<LastTradesResponse>("public/get_last_trades_by_currency_and_time",
            request);
    }
    ...
    public async Task<LastTradesResponse?> GetLastTradesByInstrumentAndTimeAsync(string instrumentName,
        long startTimestamp, long endTimestamp, int? count = 10, string? sorting = null)
    {
        var request =
            Utilities.ConvertParametersToExpandoObject(instrumentName, startTimestamp, endTimestamp, count, sorting);
        return await _deribitClient.InvokeAsync<LastTradesResponse>("public/get_last_trades_by_instrument_and_time",
            request);
    }

    public async Task<IReadOnlyCollection<IReadOnlyCollection<long>>?> GetMarkPriceHistoryAsync(string instrumentName,
        long startTimestamp, long endTimestamp)
    {
        var requestParameters =
            Utilities.ConvertParametersToExpandoObject(instrumentName, startTimestamp, endTimestamp);
        var response =
            await _deribitClient.InvokeAsync<IReadOnlyCollection<IReadOnlyCollection<long>>>(
                "public/get_mark_price_history", requestParameters);
        return response;
    }
    ...
    public async Task<OrderBookResponse?> GetOrderBookByInstrumentIdAsync(int instrumentId, int depth = 1)
    {
        ...
        return await _deribitClient.InvokeAsync<OrderBookResponse>("public/get_order_book_by_instrument_id",
            requestParameters);
    }
    ...
    public async Task<IReadOnlyCollection<string>?> GetSupportedIndexNamesAsync(string type = "all")
    {
        ...
        return await _deribitClient.InvokeAsync<IReadOnlyCollection<string>>("public/get_supported_index_names",
            requestParameters);
    }
    ...
    public async Task<List<TradeVolumeResponse>?> GetTradeVolumesAsync(bool extended = false)
    {
        ...
        var response =
            await _deribitClient.InvokeAsync<List<TradeVolumeResponse>>("public/get_trade_volumes", requestParameters);
        return response;
    }

    public async Task<TradingViewChartDataResponse?> GetTradingViewChartDataAsync(string instrumentName,
        long startTimestamp, long endTimestamp, string resolution)
    {
        var requestParameters =
            Utilities.ConvertParametersToExpandoObject(instrumentName, startTimestamp, endTimestamp, resolution);
        return await _deribitClient.InvokeAsync<TradingViewChartDataResponse>("public/get_tradingview_chart_data",
            requestParameters);
    }

    public async Task<VolatilityIndexDataResponse?> GetVolatilityIndexDataAsync(string currency, long startTimestamp,
        long endTimestamp, string resolution)
    {
        var requestParameters =
            Utilities.ConvertParametersToExpandoObject(currency, startTimestamp, endTimestamp, resolution);
        return await _deribitClient.InvokeAsync<VolatilityIndexDataResponse>("public/get_volatility_index_data",
            requestParameters);
    }

    public async Task<TickerResponse?> GetTickerAsync(string instrumentName)
    {
        return await _deribitClient.InvokeAsync<TickerResponse>("public/ticker",
            Utilities.ConvertParametersToExpandoObject(instrumentName));
    }
